...
You can check out the final project [here](https://www.youtube.com/watch?v=dQw4w9WgXcQ).
...
Then add the following to your index.css file:
...
And add daisyUI to the tailwind.config.js:
...
You can also use our CSS Style Sheet for this project, available [here]
